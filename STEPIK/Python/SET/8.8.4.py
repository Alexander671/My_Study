...
# так чтобы получить множество, содержащее уникальные слова (в нижнем регистре) 
# строки sentence sentence длиною меньше 4 символов.  
...
del_all_punct = ''.join([i for i in sentence.lower() if (str.isalpha(i) or i == ' ')]).split()

del_all_lower_4 = [i for i in  del_all_punct if len(i) < 4] 

print(*sorted(set(del_all_lower_4)))
